...
import styles from "./ServiciosSociales.module.scss";

const ServiciosSociales = () => {
        ...
        <div className="row g-3 justify-content-center">
          <div className="col-4">
            <div
              ...
              onClick={() => navigate("/visualizador-ticket/servicios-sociales")}
            >
...
export default ServiciosSociales;